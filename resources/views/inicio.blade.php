    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <p>Bienvenid@ a Alianza Unida.</p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <p style="font-size: 20px; color: #000000">Nueva Informacion:</p>
                <p style="font-size: 18px;"><strong>Precios de seguros:</strong></p>
                <span style="font-size: 18px; font-weight: bold;">Qualitas:</span>
                <span>$2,100.00</span>
                <li>$50,000 mil pesos a bienes</li>
                <li>$100,000 mil pesos a personas</li>
                <li>1 año completo</li>
                <li>Libre de deducible</li>
                <p></p>
                <span style="font-size: 18px; font-weight: bold;">Ana Seguros:</span>
                <span>$2,500.00</span>
                <li>$260,000 mil pesos a bienes</li>
                <li>$260,000 mil pesos a personas</li>
                <li>1 año completo</li>
                <li>Libre de deducible</li>
            </div>
        </div>
